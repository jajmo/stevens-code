    ...
    .then(function(db) {
        ...
        exports.login = function (username, passwordMatch, response) {
            ...
            return userCollection.findOne({ username: username }).then(function (user) {
                ...
                response.cookie(settings.cookieName, sessID);
                return "1";
            });
        };
        ...
        exports.updateProfile = function (firstName, lastName, hobby, petName, sessionID) {
            if (!firstName || !lastName || !hobby || !petName) {
                return Promise.reject("Invalid data");
            }

            return userCollection.update({ currentSessionId: sessionID }, {
                $set: {
