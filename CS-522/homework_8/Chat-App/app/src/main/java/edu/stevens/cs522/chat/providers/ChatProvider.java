...
public class ChatProvider extends ContentProvider {
    ...
    public static class DbHelper extends SQLiteOpenHelper {
        ...
        private static final String CREATE_MESSAGE = "CREATE TABLE " + MESSAGES_TABLE + " ("
                ...
                + MessageContract.SEQUENCE_NUM + " LONG, "
                + MessageContract.CHAT_ROOM + " VARCHAR NOT NULL, "
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch (uriMatcher.match(uri)) {
            case MESSAGES_SINGLE_ROW:
                ...
                String[] whereArgs = { Long.toString(ContentUris.parseId(uri)) };
                updated = db.update(MESSAGES_TABLE, values, where, whereArgs);
                break;
            case MESSAGES_ALL_ROWS:
